...
@(SNIPPET(
    ...
    script='\n'.join([
        ...
        'python3 -u $WORKSPACE/ros_buildfarm/scripts/wrapper/git.py clone --depth 1 --no-single-branch %s %s $WORKSPACE/repositories/%s' % (repo_url, repo_branch, repo_name),
